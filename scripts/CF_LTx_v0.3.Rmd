...
top9genus = sort(tapply(taxa_sums(proteo_genus), tax_table(proteo_genus)[, "Genus"], sum), decreasing = TRUE)[1:9]
top7genus = top9genus[-c(2,5)] ## remove Paraburkholderia as it is very homologous to Burkholderia, and Alteromonas as it's very likely to be contamination
...
top7genus = sort(tapply(taxa_sums(firm_genus), tax_table(firm_genus)[, "Genus"], sum), decreasing = TRUE)[1:7]
...
<!-- output_all_nbinomial_class = metalondaAll(Count = microbial.glom.count, Time = Time_real, Group = Group_real,  -->
<!--                                       ID = ID_real, fit.method = "nbinomial", n.perm = 1000,  -->
<!--                                       num.intervals = 99, parall = FALSE, pvalue.threshold = 0.1,  -->
<!--                                       adjust.method = "BH", time.unit = "days", norm.method = "none", -->
...
<!-- output_all_nbinomial_order= metalondaAll(Count = microbial.glom.count, Time = Time_real, Group = Group_real,  -->
<!--                                       ID = ID_real, fit.method = "nbinomial", n.perm = 1000,  -->
<!--                                       num.intervals = 99, parall = FALSE, pvalue.threshold = 0.1,  -->
<!--                                       adjust.method = "BH", time.unit = "days", norm.method = "none", -->
...
<!-- output_all_nbinomial_family = metalondaAll(Count = microbial.glom.count, Time = Time_real, Group = Group_real,  -->
<!--                                       ID = ID_real, fit.method = "nbinomial", n.perm = 1000,  -->
<!--                                       num.intervals = 99, parall = FALSE, pvalue.threshold = 0.1,  -->
<!--                                       adjust.method = "BH", time.unit = "days", norm.method = "none", -->
...
<!-- output_all_nbinomial_burk_species = metalondaAll(Count = microbial.glom.count, Time = Time_real, Group = Group_real,  -->
<!--                                       ID = ID_real, fit.method = "nbinomial", n.perm = 1000,  -->
<!--                                       num.intervals = 99, parall = FALSE, pvalue.threshold = 0.1,  -->
<!--                                       adjust.method = "BH", time.unit = "days", norm.method = "none", -->
<!--                                       prefix = "Lx_burk_species", col = c("firebrick", "blue")) -->
<!-- ``` -->
...
<!-- metadata.table$Subject = as.vector(metadata.table$Subject) -->
<!-- metadata.table$SampleID = rownames(metadata.table) -->
<!-- metadata.table = as.data.frame(unclass(metadata.table)) -->

<!-- omicslondaResults = list() -->
<!-- for(i in 1:nrow(count.table)){ -->
<!--   feature = as.data.frame(t(count.table[i,])) -->
<!--   feature$SampleID  = rownames(feature) -->
<!--   count_metadata_table = merge(metadata.table, feature, by = "SampleID") -->
<!--   feature_name = colnames(count_metadata_table)[ncol(count_metadata_table)] -->
<!--   colnames(count_metadata_table)[ncol(count_metadata_table)] = "Count" -->

<!--   points = seq(1,460, length.out = 100) -->
<!--   omicslondaResults[[i]] = omicslonda(formula = Count ~ Time, df = count_metadata_table, n.perm = 1000, fit.method = "ssgaussian", points = points, -->
<!--                                text = feature_name, parall = FALSE, pvalue.threshold = 0.1,      -->
<!--                                adjust.method = "BH", col = c("firebrick", "blue"),  -->
<!--                                prefix = paste("OmicsLonDA_", feature_name, sep = ""), ylabel = "NormalizedCounts",  -->
