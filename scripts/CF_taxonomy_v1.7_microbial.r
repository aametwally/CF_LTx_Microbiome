...
output.metalonda.f1 = metalonda(Count = as.matrix(count), Time = time, Group = group,
                                ...
                                text = "diversity", parall = FALSE, pvalue.threshold = 0.05,     
                                adjust.method = "none", col = c("firebrick", "blue"), ylabel = "Diversity")
...
output.metalonda.f1 = metalonda(Count = as.matrix(count), Time = time, Group = group,
                                ID = id, n.perm = 1000, fit.method = "lowess", points = points,
                                text = "FEV1 Percent Predicted", parall = FALSE, pvalue.threshold = 0.05,     
                                adjust.method = "none", col = c("firebrick", "blue"), ylabel = "FEV1 (%) Predicted")
...
output.metalonda.f1 = metalonda(Count = as.matrix(count), Time = time, Group = group,
                                ID = id, n.perm = 1000, fit.method = "lowess", points = points,
                                text = "FVC Percent Predicted", parall = FALSE, pvalue.threshold = 0.05,     
                                adjust.method = "none", col = c("firebrick", "blue"), ylabel = "FVC (%) Predicted")
...
output.metalonda.f1 = metalonda(Count = as.matrix(count), Time = time, Group = group,
                                ID = id, n.perm = 1000, fit.method = "lowess", points = points,
                                text = "FEV1 over FVC", parall = FALSE, pvalue.threshold = 0.05,     
                                adjust.method = "none", col = c("firebrick", "blue"), ylabel = "FEV1/FVC")
...
output.metalonda.f1 = metalonda(Count = as.matrix(count), Time = time, Group = group,
                                ID = id, n.perm = 1000, fit.method = "lowess", points = points,
                                text = "Lavage Total CellCount cells_per_mcL", parall = FALSE, pvalue.threshold = 0.05,     
                                adjust.method = "none", col = c("firebrick", "blue"), ylabel = "cells_per_mcL")
...
output.metalonda.f1 = metalonda(Count = as.matrix(count), Time = time, Group = group,
                                ...
                                adjust.method = "none", col = c("firebrick", "blue"), ylabel = "Neutrophil_perc")
...
output.metalonda.f1 = metalonda(Count = as.matrix(count), Time = time, Group = group,
                                ...
                                adjust.method = "none", col = c("firebrick", "blue"), ylabel = "Lymphocyte_perc")
...
output.metalonda.f1 = metalonda(Count = as.matrix(count), Time = time, Group = group,
                                ID = id, n.perm = 1000, fit.method = "lowess", points = points,
                                text = "RecentTacrolimusTroughLevel_ng_per_mL", parall = FALSE, pvalue.threshold = 0.05,     
                                adjust.method = "none", col = c("firebrick", "blue"), ylabel = "RecentTacrolimusTroughLevel_ng_per_mL")
...
output.metalonda.f1 = metalonda(Count = as.matrix(count), Time = time, Group = group,
                                ID = id, n.perm = 1000, fit.method = "lowess", points = points,
                                text = "RecentMycophenolicAcidLevel_mcg_per_mL", parall = FALSE, pvalue.threshold = 0.05,     
                                adjust.method = "none", col = c("firebrick", "blue"), ylabel = "RecentMycophenolicAcidLevel_mcg_per_mL")
...
plot_ordination(microbial, ord_pcoa_jsd, color = "Outcome") +  geom_point(size = 3) +
