...
jpeg("LgTxCF12_RarefactionCurve_0.3.jpg", res = 300, height = 15, width = 20, units = 'cm')
ggplot( data = rarefaction_curve_data_summary_verbose,
             mapping = aes(x = Depth, y = Alpha_diversity_mean, 
                ymin = Alpha_diversity_mean - Alpha_diversity_sd,
                ymax = Alpha_diversity_mean + Alpha_diversity_sd, colour = SUBJECT.WUTX,
                group = Sample)) + 
...
######################################################
jpeg("LgTxCF12_ordination_nmds_jaccard.jpg", res = 300, height = 15, width = 15, units = 'cm')
